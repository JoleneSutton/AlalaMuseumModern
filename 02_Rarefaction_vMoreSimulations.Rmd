...
cilx = aggregate(res$num.var, list(res$group,res$num.sampled), quantile, p=0.025) # lower 95% CI
ciux = aggregate(res$num.var, list(res$group,res$num.sampled), quantile, p=0.975) # upper 95% CI

new.res<-cbind.data.frame(px,cilx[,3],ciux[,3])
