...
**RESULTS**:    
  ...
  * Historical results were: 
      ...
      * 95% CIs: `r quantile(TotalPolymorphic[,1], c(0.025, 0.975))`
  * Modern results were:
    * mean: `r mean(TotalPolymorphic[,2])`
    * 95% CIs: `r quantile(TotalPolymorphic[,2], c(0.025, 0.975))`
...
<span style="color: red;">**Results: ** </span>  
  ...
  * Museum results were: 
      ...
      * 95% CIs: `r quantile(PrivateAlleles[,3], c(0.025, 0.975))`
  * Modern results were:
    * mean: `r mean(PrivateAlleles[,4])`
    * 95% CIs: `r quantile(PrivateAlleles[,4], c(0.025, 0.975))`
...
overlaps<-quantile(a, c(0.025, 0.975))%overlaps%quantile(b, c(0.025, 0.975))
overlaps

condition1<-mean(a)>mean(b) & overlaps!=TRUE
condition2<-mean(a)<mean(b) & overlaps!=TRUE
condition3<-quantile(a, c(0.025, 0.975))%overlaps%quantile(b, c(0.025, 0.975))
condition1
condition2
condition3
